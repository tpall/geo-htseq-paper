...
Our use of 40 bins leads to histograms, where an experiment with up to around 100 true effects out of 20 000 features could well lead to a uniform histogram, because of swamping of the lowermost bin (p < 0.025) with p values emanating from true null effects (S16 Fig.). 
